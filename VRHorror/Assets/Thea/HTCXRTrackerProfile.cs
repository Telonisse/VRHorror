...
namespace UnityEngine.XR.OpenXR.Features.Interactions
{
    ...
    [UnityEditor.XR.OpenXR.Features.OpenXRFeature(
        ...
        Company = "HTC",
        Desc = "Allows for mapping input to the XR Tracker interaction profile when using OpenXR runtime.",
        DocumentationLink = Constants.k_DocumentationManualURL,
        OpenxrExtensionStrings = HTCXRTrackerProfile.extensionName,
        Version = "1.0.0",
        Category = UnityEditor.XR.OpenXR.Features.FeatureCategory.Interaction,
        FeatureId = featureId)]
#endif
    public class HTCXRTrackerProfile : OpenXRInteractionFeature
    {
        /// <summary>
        /// The feature id string. This is used to give the feature a well known id for reference.
        /// </summary>
        public const string featureId = "com.htc.openxr.feature.input.xrtracker";
        ...
        {
            /// <summary>
            /// A <see cref="InputSystem.XR.PoseControl"/> that represents information from the <see cref="HTCXRTrackerProfile.grip"/> OpenXR binding.
            /// </summary>
            [Preserve, InputControl(offset = 0, aliases = new[] { "device", "gripPose" }, usage = "Device", noisy = true)]
            public InputSystem.XR.PoseControl devicePose { get; private set; }
            ...
            {
                base.FinishSetup();
                devicePose = GetChildControl<InputSystem.XR.PoseControl>("devicePose");
                ...
                var desiredCharacteristics = UnityEngine.XR.InputDeviceCharacteristics.Left;
                ...
                Debug.Log($"Characteristic: {deviceDescriptor.characteristics} {deviceDescriptor.deviceName} {deviceDescriptor.serialNumber} {deviceDescriptor.deviceId}");
                ...
                //Debug.Log($"Tracker device added: {deviceDescriptor.deviceName}");
            }
        }
        ...
        public enum InputDeviceTrackerCharacteristics : uint
        {
            ...
            TrackerLeftWrist = 0x00040000u,
            TrackerRightWrist = 0x00080000u,
