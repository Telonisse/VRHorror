...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.MetaGazeAdapter
{
    ...
    public class OculusEyeGazeInputAdapter : MonoBehaviour
    {
        ...
        // Added GameObject variable for the gaze indicator
        [Tooltip("Optional GameObject to visually indicate where the user is looking.")]
        ...
        protected void OnEnable()
        {
            ...
            // Removed obsolete PermissionDeniedAndDontAskAgain
#endif
        ...
        void ProcessPoseInput()
        {
            ...
            // Added gaze indicator update logic
            if (gazeIndicator != null)
            {
                gazeIndicator.transform.position = pose.position + (pose.orientation * Vector3.forward);
            }
        }
        ...
        {
            // Replaced the obsolete callback with ShouldShowRequestPermissionRationale query
